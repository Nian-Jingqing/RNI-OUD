function data = CR_training_slider_DEMO
...
tmp = '/home/helpdesk/Documents/MATLAB/RNI-OUD/Cue Reactivity/Cue Images/DISCO CUES/Cue Media/finalcueset/ExtractedNeutralCues/';
list = {[tmp 'Slide001.jpeg'];[tmp 'Slide002.jpeg'];[tmp 'Slide003.jpeg'];[tmp 'Slide004.jpeg'];[tmp 'Slide005.jpeg']};
for i = 1:5
    list{i,2} = 'ExtractedNeutralCues';
end
...
for j = 1:numImgs
    ...
    if isnan(RT{j})
        Screen('TextSize',w,config.textSize);
        DrawFormattedText(w,'Please use the down arrow to submit your craving','center','center',textColor,[],0,0);
        Screen('Flip',w);
        WaitSecs(2);
    end
