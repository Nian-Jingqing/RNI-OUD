...
ScreenInstruct1 = 'Select the direction of the middle arrow as quickly as possible \n\n\n Press the 1 button to continue';
ScreenInstruct2 = 'If the center arrow is facing RIGHT press the ONE button, \n\n\n if the center arrow is facing LEFT push the TWO button \n\n\n Press the 2 button to continue';
